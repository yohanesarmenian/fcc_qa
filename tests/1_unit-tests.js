...
suite('Unit Tests', function () {
  ...
  suite('Equality', function () {
    ...
    test('#equal, #notEqual', function () {
      assert.equal(12, '12', 'Numbers are coerced into strings with =='); // This assertion will pass
      assert.notEqual({ value: 1 }, { value: 1 }, '== compares object references'); // This assertion will pass
      assert.equal(6 * '2', 12); // This assertion will pass (6 * '2' is 12)
      assert.notEqual(6 + '2', 12, '6 + "2" is "62"'); // This assertion will pass (6 + '2' is "62")
    });
    // #6
  ...
  suite('Arrays', function () {
    ...
    test('#isArray, #isNotArray', function () {
      ...
      assert.isNotArray([1, 2, 3].indexOf(2), 3);
    });
    // #12
